...
from maccabipediabot.similar_song_matcher import song_exists_on_maccabipedia, SimilarMaccabiPediaSong
    ...
    if not song_exists_on_maccabipedia(song_name):
        ...
        if similar_songs_pages_names:
            ...
            context.bot.send_message(chat_id=update.effective_chat.id,
                                     text=f"לא נמצא שיר בשם: '{song_name}', אלו השירים עם השם הדומה ביותר:"
                                          f"\n{pretty_print_of_similar_songs_pages}"
