...
def process_feedback_handler(update, context):
    ...
    context.bot.forward_message(chat_id=feedback_group, from_chat_id=update.effective_chat.id,
                                message_id=update.message.message_id)
    context.bot.send_message(chat_id=update.effective_chat.id, text="תודה רבה!",
